...
create_issue "$ISSUES_DIR/done/08-tab-navigation-and-profiles.md"
create_issue "$ISSUES_DIR/done/09-products-catalog.md"
create_issue "$ISSUES_DIR/done/10-autocomplete-and-population.md"
create_issue "$ISSUES_DIR/done/11-multiple-customer-profiles.md"
create_issue "$ISSUES_DIR/done/12-customer-autocomplete-selection.md"
create_issue "$ISSUES_DIR/13-csv-product-import.md"
create_issue "$ISSUES_DIR/14-configure-google-adsense.md"
create_issue "$ISSUES_DIR/15-google-analytics-search-terms.md"
